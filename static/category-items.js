        ...
        for (const category of res) {
            for (const item of result) {
                if (item.category_name == currentCategory) {
                    $("#category-item-list").append(`<ol><form action = "/item-info/${item.item_name}" id = "farms-items">
                                                    <a id = "farm-item-list-info" href = "/item-info/${item.item_name}">
...
// currently showing category's item with duplicates *** //